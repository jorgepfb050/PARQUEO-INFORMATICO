...
namespace WindowsFormsApplication1
{
    public partial class LoginForm : Form
    {
        ...
        public LoginForm()
        {
            ...
            textColor = Color.Black;//Establecer color del cuadro de texto usuario y contraseña.
            ...
            if (userModel != null)//Si el inicio de sesión fue exitosa.
            {
               ...
               // Form mainForm;//Definir el campo para el formulario principal.
                ...
                if (ActiveUser.Position == Positions.GeneralManager || ActiveUser.Position == Positions.Accountant
                    || ActiveUser.Position == Positions.AdministrativeAssistant || ActiveUser.Position == Positions.SystemAdministrator || ActiveUser.Position == Positions.digitizer)
                {
        ...
        */
        ...
        private void lblForgotPass_Click(object sender, EventArgs e)
        {
          ...
          var frm = new FormRecoverPassword();
          frm.ShowDialog();
        }
        #endregion
        ...
        private void LoginForm_KeyPress(object sender, System.Windows.Forms.KeyPressEventArgs e)
        {
